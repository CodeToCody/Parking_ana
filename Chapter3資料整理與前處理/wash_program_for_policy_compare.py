...
BASE_DIR = os.getcwd()
INPUT_PATHS = {
    0: r"C:/Cody/Research/source2",
    1: r"D:/Research/source2"
}
OUTPUT_FILES = {
    0: r"C:/Cody/Research/clean_data/prepare2.csv",
    1: r"D:/Research/clean_data/prepare2.csv"
}
...
dropped_file = output_file.replace("prepare2.csv", "dropped_records2.csv")
